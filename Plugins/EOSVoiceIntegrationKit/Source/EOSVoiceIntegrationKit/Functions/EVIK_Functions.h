...
#include "EOSVoiceIntegrationKit/Subsystem/EIK_Voice_Subsystem.h"
...
class EOSVOICEINTEGRATIONKIT_API UEVIK_Functions : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()
...
public:
	...
	static void JoinEOSRoom(APlayerController* PlayerController, FString VoiceRoomName, FString RoomData, const FEIKResultDelegate& Result);
